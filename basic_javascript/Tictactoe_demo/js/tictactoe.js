...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("./images/drummy.png")';
            //Active player may only be 'X' or 'O' so, if not 'X' it must be 'O'

        } else {
            //if activePlayer is equal to 'O', the o.png is placed in HTML
            select.style.backgroundImage = 'url("./images/chicken.png")';
        }
...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //true is retured and our else if condition executes the drawLine() function.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        //This lines indicates where the star of a lines y axis is.
        y1 = coordY1,
        x2 = coordX2,
        y2 = coordY2,
        x = x1,

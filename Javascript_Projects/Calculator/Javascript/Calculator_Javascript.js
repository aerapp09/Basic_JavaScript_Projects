...
function Input_Digit(digit) {
    ...
    //This checks if the Wait_Second_Operand is true and sets Display_Vlaue
...
//This function updates the calculator screen w  contents of Display_Value
function Update_Display() {
    //Makes use of the calculator-screen class to target the input tag of HTML
...
keys.addEventListener('click', (event) => {
    //the target variable is an objject that represents the element
    //that was clicked.
    const { target } = event;
